CLASS /eacm/cl_rpriepmde_pdf_qry DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS /eacm/cl_rpriepmde_pdf_qry IMPLEMENTATION.
  METHOD if_rap_query_provider~select.
    ...
    DATA ls_request TYPE /eacm/cl_rpriepmde_data=>ty_rie_request.
    DATA ls_input TYPE /eacm/cl_rpriepmde_data=>ty_riep_action_input.
    DATA lt_detail TYPE /eacm/cl_rpriepmde_data=>tt_rie_detail.
    DATA lt_summary TYPE /eacm/cl_rpriepmde_data=>tt_rie_detail.
    DATA lt_pdf_data TYPE /eacm/cl_rpriepmde_data=>tt_rie_detail.
    ...
    FIELD-SYMBOLS:
      ...
      <first_row>  TYPE /eacm/cl_rpriepmde_data=>ty_rie_detail,
    ...
    /eacm/cl_rpriepmde_data=>get_data(
      EXPORTING
    ...
    TRY.
        lv_pdf = /eacm/cl_rpriepmde_form=>get_pdf_from_data(
    ...
    APPEND VALUE #(
      ...
      filename            = /eacm/cl_rpriepmde_form=>build_file_name( ls_input ) ) TO lt_result.
