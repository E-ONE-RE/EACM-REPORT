...
@EndUserText.label: 'RPRIEPMDE Form Header'
@Metadata.ignorePropagatedAnnotations: true
@ObjectModel.supportedCapabilities: [ #OUTPUT_FORM_DATA_PROVIDER ]
define root view entity /EACM/C_RPRIEPMDE_FORM_H
  as select from /EACM/I_RPRIEPMDE as Summary
  association [0..*] to /EACM/C_RPRIEPMDE_FORM_A as _Agent
    on  $projection.Bukrs = _Agent.Bukrs
    and $projection.Fkdat = _Agent.Fkdat
  association [0..*] to /EACM/C_RPRIEPMDE_FORM_V as _General
    on  $projection.Bukrs = _General.Bukrs
    and $projection.Fkdat = _General.Fkdat
  association [0..*] to /EACM/C_RPRIEPMDE_FORM_G as _GeneralTotalsByClass
