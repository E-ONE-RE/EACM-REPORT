CLASS /eacm/cl_rpriepmde_form DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    CLASS-METHODS get_pdf_from_data
      IMPORTING
        is_action_input TYPE /eacm/cl_rpriepmde_data=>ty_riep_action_input
        it_riepilogo    TYPE /eacm/cl_rpriepmde_data=>tt_rie_detail
...
CLASS /eacm/cl_rpriepmde_form IMPLEMENTATION.
  METHOD get_pdf_from_data.
    CONSTANTS lc_form_name TYPE fpname VALUE '/EACM/FR_RPRIEPMDE'.
  ...
  METHOD build_summary_form_model.
    ...
    FIELD-SYMBOLS:
      <rie>           TYPE /eacm/cl_rpriepmde_data=>ty_rie_detail,
  ...
  METHOD get_customer_texts.
    ...
    FIELD-SYMBOLS <rie> TYPE /eacm/cl_rpriepmde_data=>ty_rie_detail.
  ...
  METHOD build_file_name.
    ...
    rv_file_name = |RPRIEPMDE_{ lv_bukrs }_{ lv_fkdat }_{ lv_scope }.pdf|.
  ENDMETHOD.
ENDCLASS.
