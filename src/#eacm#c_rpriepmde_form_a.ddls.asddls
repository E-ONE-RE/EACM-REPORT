...
@EndUserText.label: 'RPRIEPMDE Form Agent'
@Metadata.ignorePropagatedAnnotations: true
define view entity /EACM/C_RPRIEPMDE_FORM_A
  as select from /EACM/I_RPRIEPMDE as Summary
  association [0..*] to /EACM/C_RPRIEPMDE_FORM_T as _AgentTotalsByClass
  ...
  association [0..*] to /EACM/C_RPRIEPMDE_FORM_C as _Currency
